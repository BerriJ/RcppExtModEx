...
#include "../inst/include/RcppExtModEx_types.h"
...
RcppExport SEXP _RcppExtModEx_mapIn_and_mapOut(SEXP mymapSEXP) {
BEGIN_RCPP
...
// makeFoo
Foo makeFoo();
RcppExport SEXP _RcppExtModEx_makeFoo() {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _RcppExtModEx_getMap(SEXP instanceSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _RcppExtModEx_setMap(SEXP instanceSEXP, SEXP mymapSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Foo& >::type instance(instanceSEXP);
    Rcpp::traits::input_parameter< const std::map<std::string, arma::colvec>& >::type mymap(mymapSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_RcppExtModEx_mapIn_and_mapOut", (DL_FUNC) &_RcppExtModEx_mapIn_and_mapOut, 1},
    {"_RcppExtModEx_makeFoo", (DL_FUNC) &_RcppExtModEx_makeFoo, 0},
    {"_RcppExtModEx_getMap", (DL_FUNC) &_RcppExtModEx_getMap, 1},
    {"_RcppExtModEx_setMap", (DL_FUNC) &_RcppExtModEx_setMap, 2},
    {"_rcpp_module_boot_FooEx", (DL_FUNC) &_rcpp_module_boot_FooEx, 0},
    {NULL, NULL, 0}
};

RcppExport void R_init_RcppExtModEx(DllInfo *dll) {
